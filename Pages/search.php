...
<?php
// Kullanıcının arama terimini al ve özel karakterleri temizle
$ara = '%' . ($_GET['ara'] ?? '') . '%'; // Arama terimini '%ara%' yaparak LIKE sorgusu için hazırlar
...
<div class="container my-4">
    <div class="row">
        ...
        <!-- SOL BOLUM (START) -->
        <?php include '../Col/searchLeftCol.php'; ?>
        <!-- SOL BOLUM (END) -->
